...
public class RunInfoDBHelper extends SQLiteOpenHelper {
    ...
    // 步骤1：设置常数参量
    private static final String DATABASE_NAME = "appRunSeq_db";
    private static final int VERSION = 1;
    private static final String TABLE_NAME = "app_run_info";
     ...
     * version 数据库版本号
     */
    public RunInfoDBHelper(Context context, String name, SQLiteDatabase.CursorFactory factory,
                          int version) {
